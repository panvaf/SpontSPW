# merge networks and add B to S connections

# 12 % is enough to switch off S (g = 0.4)
# 1.6 is enough (4 %)
# 8 % and .8 is enough
...
FR_width = 200.1*ms    # Window for smoothing firing rates
...
# check if they can switch states
...
# ICI CV for pyramidal cells = 0.713922
# Correlation coefficient averaged for 100 pyramidal neuron pairs = 0.030078  

# for 30 seconds:
# ICI CV for pyramidal cells = 0.756097
# Correlation coefficient averaged for 100 pyramidal neuron pairs = 0.002313 